...
<div class="eventsInfo">
    ...
    <div class="info">
        ...
        <div class="info-buttons">
            <a class="btn-details" href="/theater/${theater._id}">Details</a>
        </div>
    </div>
</div>
`;
    ...
    <div id="events">
        ...
        <div class="theaters-container">
            ...
            ${theaters.length != 0 ? html`
                ${theaters.map(x=>theaterTemplate(x))}
            `: html`
            <!--No Theaters-->
...
export const homeView = (ctx) => {
    theaterService.getAll().then(theaters=>{
        render(homeTemplate(theaters), document.querySelector('#container'));
    })
}